...
#     vowels = ['a', 'e', 'i', 'o', 'u']
#     user_letter = input("Is your letter a vowel").lower()
...
#     if age < 0:
#           age = int(input("Please Enter a valid age").lower())
#     voting_age = 18
#     if age >= voting_age: 
#          print('valid to vote')
#     else:
...
#         if month == 'feb' or month == "jan" or (month == 'dec' and day >= 21) or (month == 'mar' and day <= 19):
#             print(f'{month} {day} is in winter')
#         elif month == 'may' or month == "apr" or (month == 'mar' and day >= 20) or (month == 'jun' and day <= 20):
#             print(f'{month} {day} is in spring')
#         elif month == 'aug' or month == "jul" or (month == 'jun' and day >= 21) or (month == 'sep' and day <= 21):
#             print(f'{month} {day} is in summer')
#         elif month == 'oct' or month == "nov" or (month == 'sep' and day >= 22) or (month == 'dec' and day <= 20):
#             print(f'{month} {day} is in summer')
...
def guess_number():
    ...
    target_num = 42
    for num in range(5):
        num_guess = int(input('Enter a number between 1-100'))
